        ...
        <section className="bg-primary py-10 md:py-20 relative overflow-hidden">
          <div className="mx-auto max-w-[1200px] px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="rounded-2xl shadow-2xl overflow-hidden">
              <img src={equipePhoto} alt="Mika Musungayi — Fondateur MFinances, expert-comptable à Uccle" className="w-full h-[340px] md:h-[400px] object-cover object-center" />
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-[1200px] px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <SR delay={0.15}>
              <img
                ...
                className="rounded-2xl w-full h-[280px] md:h-[340px] object-cover shadow-lg"
              />
            </SR>
          </div>
        </section>
