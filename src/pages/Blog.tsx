            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {problemCards.map((card, i) => (
                <Link
                  ...
                  className="group text-left bg-card rounded-2xl overflow-hidden border border-border/50 hover:border-accent/40 hover:shadow-[0_8px_30px_rgba(27,43,94,0.08)] transition-all duration-300 h-full flex flex-col"
