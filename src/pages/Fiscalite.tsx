...
export default function Fiscalite() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Optimisation Fiscale pour TPE à Bruxelles — MFinances";
    ...
    setMeta("description", "Optimisation fiscale ISOC, IPP, TVA et planification patrimoniale pour dirigeants de TPE en Belgique. Cabinet MFinances, Bruxelles. Consultation gratuite.");

    let canonical = document.querySelector('link[rel="canonical"]') as HTMLLinkElement;
    if (!canonical) { canonical = document.createElement("link"); canonical.rel = "canonical"; document.head.appendChild(canonical); }
    canonical.href = "https://mfinances.be/services/fiscalite/";
