...
import imgHero from "@/assets/societe-exploitation-hero.webp";
            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
              <div className="lg:col-span-7">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-accent/75 text-[11px] font-bold tracking-[0.25em] uppercase">Structure : N°03</span>
                </div>
